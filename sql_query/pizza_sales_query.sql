create database ovenstory_pizza;
use ovenstory_pizza;
...
select * from ovenstory_pizza.pizzas;
select * from ovenstory_pizza.orders;
select * from ovenstory_pizza.order_details;
select * from ovenstory_pizza.pizza_types;
...
select category, count(name) as variety
from pizza_types
group by category;

-- Q9. Group the orders by date and calculate the average number of pizzas ordered per day.
select round(avg(pizza_orders),0) as average_pizza_per_day from
